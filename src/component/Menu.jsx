...
export default function Menu() {
    ...
    return (
        ...
        <nav className="bg-Blue-secondary text-light-default dark:bg-gray-900 w-full border-gray-200 dark:border-gray-600 my-10 rounded-lg">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
                        <li>
                            <a href="#" className="block py-2 px-3  rounded md:bg-transparent md:text-Blue-default md:p-0 md:dark:text-Blue-default" aria-current="page">Home</a>
                        </li>
                        <li>
